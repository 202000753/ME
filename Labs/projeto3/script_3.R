...
#year_born->X->É o ano de nascimento dos individuos observados no presente estudo

# Regra Sturges
(n1 <- length(dfMain$year_born)) # n = dimensão da amostra

(k1<-trunc(1+log(n1)/log(2)))# k = número de classes = número de linhas da tabela
...
#######################################################################################
#######################################################################################
# O histograma indica uma distribuição aproximadamente Normal
